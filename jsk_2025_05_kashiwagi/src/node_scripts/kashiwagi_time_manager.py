...
class StateAutoResetter:
    def __init__(self):
        ...
        self.target_states = ["daily:happy", "daily:waking_up", "daily:goodbye", "talking_game:starting", "talking_game:happy", "move:surprised", "katakanashi:starting", "katakanashi:happy", "move:happy", "move:goal"]
