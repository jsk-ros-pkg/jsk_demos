...
# mainly copied from https://github.com/sktometometo/jsk_demos/blob/e357a474a44209236e6c9d2c79bda7d0c1c94951/jsk_spot_delivery_demo/node_scripts/delivery_action_server.py #NOQA
...
class DeliveryActionServer:
    ...
    def __init__(self):
        ...
        self.actionserver_pickup_package = actionlib.SimpleActionServer(
            ...
            self.callback_call_person, auto_start=False)
    ...
    def head_for_person(self, use_pitch=True):
        ...
        if use_pitch:
            self.spot_ros_client.pubBodyPose(
                0,Quaternion(x=0, y=math.sin(-pitch/2), z=0, w=math.cos(-pitch/2)))
        return True
    ...
    def callback_call_person(self, goal):
