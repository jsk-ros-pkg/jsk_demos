...
class TemperatureRecognition():
    def __init__(self):
        ...
        self.pub_go_back = rospy.Publisher('go_back', String, queue_size=10)
        self.pub_matched_face = rospy.Publisher('matched_face', Vector3Stamped, queue_size=10)
        self.subscribe_name()
    ...
    def name_cb(self, msg):
        ...
        if(self._color == "green" or self._color == "yellow" or (self._color == red and count == 3)):
            ...
            new_msg = "go"
            self.pub_go_back.publish(new_msg)
            print("/go_back published")
            ...
            self.pub_matched_face.publish(new_msg)
            print("/matched_face published")
